    ...
    aboutText = () => {
        return (
            <div className={styles.textDiv}>
                <p>
                    My name is <span className={styles.name}>Trevor Linan</span> and my <span className={styles.name}>passion</span> has guided me to a life where not a single day
                    goes by that I don&#39;t love writing code and designing the connection between a web
                    page and its user.
                </p>
                <hr />
                <p>
                    As cold and robotic as the interaction may seem between technology
                    ...
                    mimicking that of its predecessor; <span className={styles.name}>genuine</span> human interaction. With marketing and
                ...
                <p>
                    ...
                    <span className={styles.name}> human experience</span> and I will have been proud to be a part of it creating one genuine
